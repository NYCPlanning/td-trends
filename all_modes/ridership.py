...
fig = fig.add_trace(go.Bar(name='Hospitalizations',
                           x = df.loc[df['Mode'] == 'Hospitalizations', 'YearMonth'],
                           y = df.loc[df['Mode'] == 'Hospitalizations', 'Value'],
                           yaxis='y2',
                           showlegend = True,
                           marker={'color':'rgba(162,162,162,0.4)'},
                           hoverinfo = 'text',
                           hovertext = ['<b>Hospitalizations: </b>'+'{:,.0f}'.format(x)  for x in df.loc[df['Mode'] == 'Hospitalizations', 'Value']]))
...
fig.update_layout(template = 'plotly_white',
                  ...
                  xaxis = {'title': {'text': '<b>Month</b>',
                           ...
                           'fixedrange': True,
                           'showgrid': False},
                  yaxis = {'title':{'text': '<b>Percent of Same Month in 2019</b>',
                                    'font_size': 14},
                           'tickfont_size': 12,
                           'tickformat': '.0%',
                           'side':'left',
                           ...
                           'fixedrange': True,
                           'showgrid': True},
                  yaxis2 = {'title':{'text': '<b>Hospitalizations</b>',
                                    'font_size': 14,
