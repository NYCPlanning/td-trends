...
fig.update_layout(
    ...
    title={'text':'<b>Households without Access to Vehicles</b>',
           'font_size':20,
           'x':0.5,
           'xanchor':'center',
           'y':0.95,
    ...
    yaxis={'title':{'text':'<b>Number of Households</b>',
                    'font_size':14},
           'tickfont_size':12,
           'rangemode':'tozero',
           'fixedrange':True,
...
fig.add_annotation(
    ...
    text='Data Source: <a href="https://data.census.gov/cedsci/table?t=Transportation&g=0500000US36005,36047,36061,36081,36085&tid=ACSDT1Y2019.B08201" target="blank">Census Bureau ACS 1-Year</a> | <a href="https://raw.githubusercontent.com/NYCPlanning/td-trends/main/dmv/ACSAnnual.csv" target="blank">Download Chart Data</a>',
    font_size=14,
    showarrow=False,
    x=1,
    xanchor='right',
